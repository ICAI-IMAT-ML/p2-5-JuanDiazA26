...
class LogisticRegressor:
    ...
    def ridge_regularization(self, dw, m, C):
        ...
        ridge_gradient = (C/m) * abs(self.weights) * np.sign(self.weights)
    ...
    def elasticnet_regularization(self, dw, m, C, l1_ratio):
        ...
        elasticnet_gradient = l1_ratio * (self.lasso_regularization(dw, m, C) - dw) + (1 - l1_ratio) * (self.ridge_regularization(dw, m, C) - dw)
